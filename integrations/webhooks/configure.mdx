...
description: Register a webhook endpoint, subscribe to workspace events, and receive HTTP POST notifications whenever those events occur in real time.
---
...
<Steps>
  ...
  <Step title="Select events">
    ...
    Each event type has its own payload schema documented in your workspace's developer settings.
  </Step>
