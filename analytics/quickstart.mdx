---
title: Analytics quickstart guide for new workspaces
sidebarTitle: Quickstart
description: Set up Analytics in minutes. Connect a data source, build your first dashboard with charts, and explore your data without writing SQL.
---
...
- Add more charts to your dashboard to visualize different aspects of your data.
