...
description: Manage team members across the full lifecycle. Invite users by email, adjust roles, deactivate accounts, and bulk-import members from CSV files.
---
